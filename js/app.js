/*! 2016 51h5.com All Rights Reserved */
...
function(t, e, i, n) {
    ...
    function C(t, e) {
        ...
        e.scale = a ? N(a.pointers, n) : 1,
        e.rotation = a ? q(a.pointers, n) : 0,
        D(i, e);
        var l = t.element;
    ...
    function D(t, e) {
        ...
        if (e.eventType != Ce && (u > Te || o.velocity === n)) {
    ...
    function q(t, e) {
        return M(e[1], e[0], Ne) - M(t[1], t[0], Ne)
    }
    function N(t, e) {
        return L(e[0], e[1], Ne) / L(t[0], t[1], Ne)
    }
    function j() {
        this.evEl = He,
        this.evWin = ze,
    ...
    function F(t, e) {
        ...
        if (e & (Se | Ce)) i = w(i.concat(n), "identifier", !0);
        return [i, n]
    }
    function $() {
        this.evTarget = Ge,
    ...
    function B(t, e) {
        ...
        for (r = 0; r < a.length;) {
            ...
            if (e & (Se | Ce)) delete n[a[r].identifier];
            r++
        }
    ...
    l(z, _, {
        handler: function(t) {
            ...
            if (this.started) {
                ...
                if (e & (Se | Ce) && i[0].length - i[1].length === 0) this.started = !1;
                this.callback(this.manager, e, {
                    pointers: i[0],
                    changedPointers: i[1],
                    pointerType: be,
    ...
    V.prototype = {
        set: function(t) {
            if (t == Qe) t = this.compute();
            if (Ze) this.manager.element.style[Je] = t;
    ...
    l(Q, Z, {
        ...
        directionTest: function(t) {
            ...
            s = t.deltaX,
            a = t.deltaY;
            if (! (r & e.direction)) if (e.direction & Pe) r = 0 === s ? ke: 0 > s ? De: Re,
            i = s != this.pX,
            n = Math.abs(t.deltaX);
            else r = 0 === a ? ke: 0 > a ? Oe: Ie,
            i = a != this.pY,
            n = Math.abs(t.deltaY);
    ...
    l(te, U, {
        ...
        process: function(t) {
            ...
            if (this._input = t, !n || !i || t.eventType & (Se | Ce) && !s) this.reset();
...
define("lang/cn", [], {
    ...
    play: "å¼€å§‹",
    download: "ä¸‹è½½",
    server_error: "æœåŠ¡å™¨å¿™, è¯·ç¨åŽé‡è¯•",
    please_login: "æ‚¨è¿˜æ²¡æœ‰ç™»å½•, è¯·ç™»å½•åŽæ“ä½œ",
    favorited: "å·²æ”¶è—",
    ranking: "æŽ’å",
    score: "åˆ†",
    guest: "æ¸¸å®¢",
    in_claim: "å·²æäº¤è®¤é¢†ç”³è¯·",
    input_claim_name: "è¯·å¡«å†™ä½œè€…åæˆ–å“ç‰Œå",
    input_mobile: "è¯·å¡«å†™æ‰‹æœºå·",
    input_email: "è¯·å¡«å†™é‚®ç®±",
    add2desktop: 'å…ˆç‚¹å‡»<i class="icon-share"></i>,<br/>å†ç‚¹å‡»"æ·»åŠ åˆ°ä¸»å±å¹•"',
    click_fav_rt: "ç‚¹å‡»å³ä¸Šè§’æ”¶è—",
    find_anytime: "ä»¥åŽå¯éšæ—¶æ‰¾åˆ°æˆ‘ä»¬å“¦~",
    install_app: "å®‰è£…ç«èˆžå®¢æˆ·ç«¯, ç²¾å½©æ— æžé™",
    android_ori: "å®‰å“æ­£å¼ç‰ˆ",
...
function() {
    ...
    function e(t, e, r, s) {
        var a = [n + "trackEvent", t, e];
        if (r) a.push(r);
        if (s) a.push(parseInt(s, 10));
        i(a)
    }
...
function(t) {
    ...
    var q = 'data=data||{};var v={},fs=engine.filters,hg=typeof data.get=="function",gv=function(n,ps){var p=ps[0],d=v[p];if(d==null){if(hg){return data.get(n);}d=data[p];}for(var i=1,l=ps.length;i<l;i++)if(d!=null)d = d[ps[i]];return d;},ts=function(s){if(typeof s==="string"){return s;}if(s==null){s="";}return ""+s;};';
    r(g, d),
    r(m, d),
    r(v, d),
    r(y, d),
    ...
    g.prototype.getRenderer = function() {
        ...
        if (this.isReady()) {
            var t = new Function("data", "engine", [q, I, this.getRendererBody(), M].join("\n")),
            e = this.engine;
    ...
    g.prototype.close = function(t) {
        d.prototype.close.call(this, t),
        this.state = this.master ? N.READED: N.APPLIED,
        t.target = null
    },
    ...
    C.prototype.compile = C.prototype.parse = function(t) {
        if (t) {
            var e = k(t, this);
    ...
    C.prototype.addFilter = function(t, e) {
        if ("function" == typeof e) this.filters[t] = e
    };
    var H = new C;
    if (H.Engine = C, "object" == typeof exports && "object" == typeof module) exports = module.exports = H;
...
function(require, exports) {
    function t(t) {
        ...
        if (i.main && i.button) {
            ...
            this.ext = (o(i.main, "ext") || "").replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "").split(","),
    ...
    function a(t) {
        ...
        if (this.ext) this.ext.forEach(function(e) {
            if (t.hasOwnProperty(e)) n.exts[e] = t[e]
        });
        if (this.main.appendChild(u(this.render(n))), !t.isfull) s.call(this, !0)
    }
    function o(t, e, i) {
        var n = h.getData(t, e);
...
function() {
    function t(t) {
        ...
        C = t.match(/SogouMobileBrowser\/([\d.]+)/),
        k = r && t.match(/MiuiBrowser\/([\d.]+)/),
        D = t.match(/LBKIT/),
        R = t.match(/Mercury\/([\d.]+)/);
...
define("report", ["require", "saber-dom", "saber-lang", "saber-lang/function/debounce", "saber-ajax"],
function(require) {
    function t(t, e) {
    ...
    function e() {
        var t = o.queryAll("input,textarea", this);
        return t.filter(function(t) {
            var e = t.type;
            return t.name && !o.matches(t, ":disabled") && d.test(t.nodeName) && !f.test(e) && (t.checked || !p.test(e))
        }).map(function(t) {
            return {
                name: t.name,
                value: t.value
    ...
    function i(t) {
        var e = o.closest(t.target, ".ui-label"),
        i = "active";
        if (e) t.preventDefault(),
        o.queryAll(".ui-label").forEach(function(t) {
            o.removeClass(t, i)
        }),
        o.addClass(e, i),
        o.query('input[type="radio"]', e).checked = !0
    }
    function n(t) {
        var e, i, n, r = o.closest(t.target, '[data-role="captcha"]');
        if (r) {
            if (t.preventDefault(), e = o.getData(r, "url"), e = e + (~e.indexOf("?") ? "&": "?") + Math.random(), i = o.query("img", r), n = o.query("input", o.closest(r, ".form-group")), !i) r.appendChild(i = new Image);
            i.src = e,
            n.value = ""
        }
    }
    function r(t) {
        ...
        if (1 === e.status) o.show(o.g("feedback")),
        c(),
        this.reset(),
        o.queryAll(".ui-label").forEach(function(t) {
            var e = o.query("input", t);
            if (e) o[e.checked ? "addClass": "removeClass"](t, "active")
        });
        else s.call(this, e)
    }
    function s(t) {
        alert(t.data || "æäº¤å¤±è´¥ï¼Œè¯·ç¨åŽé‡è¯•")
    }
    function a(i) {
        i.preventDefault();
        var n, a = this.getAttribute("action"),
        l = this.getAttribute("method"),
        c = e.call(this),
        f = o.getData(this, "lock"),
        d = {};
        if (a && "1" !== f) o.setData(this, "lock", 1),
        c.forEach(function(t) {
            d[t.name] = t.value
        }),
        n = h[l](a, d),
        n.then(u.bind(r, this), u.bind(s, this)),
        n.ensure(u.bind(function() {
            var e = o.query('[data-role="captcha"]', this);
            if (o.setData(this, "lock", 0), e) t.call(e, "touchstart")
        },
        this))
    }
    var o = require("saber-dom"),
    u = require("saber-lang"),
    l = require("saber-lang/function/debounce"),
    h = require("saber-ajax"),
    exports = {},
    c = l(function() {
        o.hide(o.g("feedback"))
    },
    3e3),
    f = /^(?:submit|button|image|reset|file)$/i,
    d = /^(?:input|select|textarea|keygen)/i,
    p = /^(?:checkbox|radio)$/i;
    return exports.init = function() {
        var t = o.query("form[async]"),
        e = o.query('[data-role="radio"]'),
        r = o.query('[data-role="captcha"]');
        if (t) t.addEventListener("submit", a, !1);
        if (e) e.addEventListener("touchstart", i, !1);
        if (r) r.addEventListener("touchstart", n, !1)
    },
    exports
}),
...
define("app", ["require", "saber-emitter", "saber-dom", "saber-lang/extend", "saber-string/format", "saber-lang/function/debounce", "saber-ajax", "saber-widget", "saber-widget/Slider", "saber-widget/LazyLoad", "saber-widget/ImageView", "./lang/main", "./common/pv", "./common/pullrefresh", "./common/swipe", "saber-env", "saber-tap", "./report", "saber-widget/plugin/SliderFlex", "saber-widget/plugin/Masker", "saber-widget/plugin/ImageViewFlex", "etpl", "./app.tpl", "saber-cookie"],
function(require) {
    function t(t, e, i, n) {
    ...
    var e = require("saber-emitter"),
    i = require("saber-dom"),
    n = require("saber-lang/extend"),
    r = require("saber-string/format"),
    s = require("saber-lang/function/debounce"),
    a = require("saber-ajax"),
    o = require("saber-widget");
    require("saber-widget/Slider"),
    require("saber-widget/LazyLoad"),
    require("saber-widget/ImageView");
    var u = require("./lang/main"),
    l = require("./common/pv"),
    h = require("./common/pullrefresh"),
    c = require("./common/swipe"),
    f = u.get,
    d = i.query,
    p = i.queryAll,
    g = require("saber-env"),
    m = navigator.userAgent,
    v = /Hoowu\/[\d.]+/.test(m) || /Html5Plus\/[\d.]+/.test(m),
    y = g.os.ios,
    b = g.browser.wechat,
    w = /AliApp\(AP\/[0-9.]+\)|AlipayClient\/[0-9]+/.test(m),
    E = !!window.PAGE_INDEX,
    x = !!window.PAGE_GAME_INFO,
    T = "/game/${id}.html",
    _ = {
        gameuri: function(t) {
            var e = r(T, {
    ...
    exports.init = function(t) {
        ...
        this.initDownTip(),
        this.initNotice(),
        require("./report").init(t),
        console.info("app start")
    },
    exports.initEvent = function() {
        for (var t in A) for (var e in A[t]) window[t].addEventListener(e, A[t][e], !1)
    },
    exports.initTrackEvent = function() {
        if (E) this.addEvent(document.body, "touchstart",
        function(t) {
            var e = t.target || t.srcElement;
            if (e) {
                var n = "[data-track]";
                if (!i.matches(e, n)) e = i.closest(e, n, document.body);
                if (e) l.track("mwwwindex", i.getData(e, "track"))
            }
        })
    },
    exports.initHeader = function() {
        if (d(".ui-bar[data-ui~=nav]")) this.on("scroll",
        function() {
            i[(window.pageYOffset >= 44 ? "add": "remove") + "Class"](document.body, "header-fixed")
        })
    },
    exports.initHiddens = function() {
        ...
        p(e).forEach(function(t) {
            if (!n || !i.hasClass(t, "hide-uc")) {
                var e = d('script[type="text/template"]', t);
                if (e) t.innerHTML = e.innerText,
                r.initDownTip(t);
                i.removeClass(t, "hidden")
            }
        })
    },
    exports.initForm = function() {
        function t(t, e) {
            i.setData(t, "submiting", e ? "true": "")
        }
        function e(t, e) {
            if (t) {
                var n = i.closest(t, "[data-role=field]");
                if (n) if (e) i.removeData(n, "error");
                else i.setData(n, "error", "true")
            }
        }
        function n(n) {
            n.preventDefault();
            var r = this;
            if ("true" !== i.getData(r, "submiting")) {
                t(r, !0);
                ...
                a.post(this.action, s).then(function(n) {
                    t(r);
                    var s;
                    try {
                        s = JSON.parse(n)
                    ...
                    else alert(f("server_error"))
                },
                function() {
                    t(r),
                    alert(f("server_error"))
                })
            }
        }
        p("form[data-role=form][data-type=ajax]").forEach(function(t) {
            t.addEventListener("submit", n, !1)
        })
    },
    exports.initFav = function() {
        if (x) {
            ...
            if (t) {
                var e, n = this,
                r = function() {
                    t.innerHTML = '<i class="icon-ok"></i>' + f("favorited"),
                    n.addUIData(t, "disabled")
                },
                s = i.getData(t, "check");
                if (s) a.post(s).then(function(t) {
                    var e;
                    try {
                        e = JSON.parse(t)
                    } catch(i) {}
                ...
                n.addEvent(t, "click",
                function(n) {
                    if (n.preventDefault(), !e) e = !0,
                    a.post(i.getData(t, "url"), {
                        id: i.getData(t, "id")
                    }).then(function(t) {
                        e = !1;
                        var i;
    ...
    exports.initLike = function() {
        ...
        if (x) {
            var e = d(".like[data-id]");
            if (e) {
                var n = this;
                n.addEvent(e, "click", t);
                var r
            }
        }
    }, exports.initPopMenu = function() {
        var t = this;
        p(".ui-btn[data-popmenu]").forEach(function(e) {
            var n = i.getData(e, "popmenu");
            if (n = n ? d("#" + n) : null) t.addEvent(n, "click",
            function(t) {
                t.stopPropagation();
                var e = i.getData(t.target, "url");
                if (e) if ("blank" === i.getData(t.target, "target")) window.open(e);
            ...
            function(t) {
                t.preventDefault();
                var e = "none" === i.getStyle(n, "display");
                if (i[e ? "show": "hide"](n), e) {
                    var r = i.position(this);
                    i.setStyle(n, "left", r.left + (this.offsetWidth - n.offsetWidth) / 2 + "px"),
                    i.setStyle(n, "top", r.top + this.offsetHeight + 4 + "px")
                }
            })
        })
    },
    exports.initWa = function() {
        ...
        if (t && d("#waList")) {
            ...
            function(r) {
                ...
                a.post(i.getData(t, "source")).then(function(t) {
                    e = !1;
                    var r;
                    try {
                        r = JSON.parse(t)
                    ...
                    if (r && 1 === r.status) {
                        var a = d("#waList");
                        a.innerHTML = n.renderTpl("guess", {
                            items: r.data
                        }),
                        n.initSwipe(i.closest(a, "[data-role=body]"))
    ...
    exports.initGoTop = function() {
        ...
        function() {
            var t = d(".gotop");
            if (t) i[window.pageYOffset > 60 ? "show": "hide"](t)
        })
    },
    exports.initDownTip = function(t) {
        if (t || b) p("a[href][data-link=down]", t).forEach(function(t) {
    ...
    exports.initNotice = function() {
        ...
        if (t) {
            ...
            if (! (e.length < 2)) setInterval(function() {
                var n = parseInt(i.getData(t, "now") || 0, 10) || 0;
                if (i.removeClass(e[n], "show"), ++n >= e.length) n = 0;
                i.setData(t, "now", n),
                i.addClass(e[n++], "show")
            },
            parseInt(i.getData(t, "time") || 0, 10) || 6e3)
        }
    },
    exports.initHideStatusBar = function() {
        if (y) window.scrollTo(0, 1);
    ...
    exports.initPullRefresh = function() {
        var t, e = d(".container .more");
        if (e) {
            if (t = d(i.getData(e, "for")), !t) {
                var n = i.closest(e, "section");
                if (n) t = d(".list", n)
            }
            if (!t) t = p(".container .list"),
            t = t[t.length - 1]
        }
        if (t && e) h.init({
            main: t,
            ...
            complete: function(t, e) {
                l.add(e.api.replace(/_page_/g, t))
            }
        })
    },
    exports.initSwipe = function(t) {
        if (t) {
            ...
            if (e) e.resize().reset()
        } else p("[data-role=swipe]").forEach(function(t) {
            new c({
                main: d("[data-role=body]", t),
                target: d(".list", t)
            })
        })
    },
    exports.initSliders = function() {
        ...
        [].forEach.call(p(".ui-slider"),
        function(t) {
            var e = i.getData(t, "opt");
            if (e) try {
                e = JSON.parse(e)
            } catch(r) {}
            var s = o.slider(t, n({
            ...
            e || {}));
            if (e.dot && !d("[data-role=dot]", t)) {
                var a = document.createElement("div");
                a.setAttribute("data-role", "dot");
                for (var u = "",
                l = s.get("length"), h = s.get("index"), c = 0; l > c; c++) u += "<b" + (c === h ? ' class="active"': "") + "></b>";
                a.innerHTML = u,
                t.appendChild(a)
            }
            if (d("[data-role=dot]", t)) s.on("change",
            function(t, e, n) {
                i.children(d("[data-role=dot]", this.get("main"))).forEach(function(t, e) {
                    i[e === n ? "addClass": "removeClass"](t, "active")
                })
            });
            if ("true" === i.getData(t, "preview") && p("img", s.get("main")).length > 1) {
                require("saber-widget/plugin/Masker"),
                require("saber-widget/plugin/ImageViewFlex");
                var f = o.imageView(s.get("main"), {
                    flex: !0
                });
                s.addEvent(s.get("main"), "click",
                function(t) {
                    if (i.matches(t.target, "img")) f.enable().to(t.target)
                })
            }
        })
    },
    exports.initTabs = function() {
        var t = this; [].forEach.call(p(".ui-tab"),
        function(e) {
            e.addEventListener("click",
            function(e) {
                var n = e.target || e.srcElement;
                if (i.hasClass(n, "ui-btn")) {
                    e.preventDefault();
                    var r = i.getData(n, "url");
                    if (r) return void(location.href = r);
                    var s = i.getData(n, "for"); [].map.call(p(".ui-btn", i.closest(n, ".ui-tab")),
                    function(e) {
                        return t[e === n ? "addUIData": "removeUIData"](e, "active"),
                        i.getData(e, "for")
                    }).forEach(function(e) {
                        t[e === s ? "addUIData": "removeUIData"](d("[data-role=" + e + "]"), "active")
                    });
                    var e = i.getData(n, "event");
                    if ("true" === (e || "").toLowerCase()) return void exports.emit("tab.active", {
                        name: s
                    })
                }
            },
    ...
    exports.initSearch = function() {
        ...
        function(t) {
            if ("submit" === t.type && 0 === d("[data-role=input] > input", this).value.trim().length) t.preventDefault();
            i.removeClass(d(".icon-close", this), "active")
        },
        !1), this.addEvent(d("[data-role=input] > input", t), "input focus blur",
        function(t) {
            var e = this.value.trim().length > 0;
            i[e ? "addClass": "removeClass"](d(".icon-close", this.parentNode), "active");
            var n = t.type;
            if ("focus" === n || "blur" === n) i["focus" === n || e ? "addClass": "removeClass"](i.closest(this, "form"), "focus")
        }), this.addEvent(d(".icon-close", this.parentNode), "click",
        function(t) {
            t.preventDefault(),
            i.removeClass(this, "active");
            var e = d("input", this.parentNode);
            e.value = "",
            e.focus()
        }), d(".tags") && d(".tag-fresh")) this.addEvent(d(".tag-fresh"), "click",
        function(t) {
            t.preventDefault();
            var e = this;
            if (!i.hasClass(e, "_busy")) i.addClass(e, "_busy"),
            a.post(i.getData(e, "action")).then(function(t) {
                i.removeClass(e, "_busy");
                var n;
                try {
                    n = JSON.parse(t)
                } catch(r) {}
                if (n && 1 === n.status) d(".tags").innerHTML = n.data
            },
            function() {
                i.removeClass(e, "_busy")
            })
    ...
    exports.toggleInput = function(t, e) {
        i[e ? "hide": "show"](d(".container")),
        [].forEach.call(p("body > .ui-bar"),
        function(t) {
            i[e ? "hide": "show"](t)
        });
        var n;
        if ("comment" === t) n = d(".input-box"),
        i[e ? "show": "hide"](n),
        d("textarea", n).focus();
        else if ("claim" === t) n = d("#claimBox"),
        i[e ? "show": "hide"](n);
        this.initHideStatusBar()
    },
    exports.getUIData = function(t) {
        if (t) return (i.getData(t, "ui") || "").trim().replace(/\s\s+/g, " ").split(" ");
        else return []
    },
    exports.addUIData = function(t, e) {
        var n = this.getUIData(t);
        if (n.length && n.indexOf(e) < 0) n.push(e),
        i.setData(t, "ui", n.join(" "))
    },
    exports.removeUIData = function(t, e) {
        var n = this.getUIData(t);
        if (n.length) n = n.filter(function(t) {
            return t !== e
        }).join(" "),
        i.setData(t, "ui", n)
    },
    exports.addEvent = function(e, i, n) {
        return t("add", e, i, n),
        this
    },
    exports.removeEvent = function(e, i, n) {
        return t("remove", e, i, n),
        this
    },
    exports.renderTpl = function(t, e) {
        if (!this.render) {
            var i = require("etpl"),
            r = new i.Engine;
            for (var s in _) r.addFilter(s, _[s]);
            this.render = r.compile(require("./app.tpl"))
        }
